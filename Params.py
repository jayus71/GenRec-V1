...
def ParseArgs():
	...
	# DDIM and Importance Sampling params
	parser.add_argument('--use_ddim', type=str2bool, default=False, help='Use DDIM accelerated sampling')
	parser.add_argument('--ddim_steps', type=int, default=2, help='DDIM sampling steps (2 or 3)')
	parser.add_argument('--importance_sampling', type=str2bool, default=False, help='Use importance sampling for timesteps')
	parser.add_argument('--loss_momentum', type=float, default=0.9, help='Momentum for timestep loss moving average') 
